  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <LineChart data={data} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
        ...
        <Tooltip contentStyle={tooltipStyle(p)} labelStyle={{ color: p.tooltipLabel }} />
        <Line type="monotone" dataKey="bbUpper" stroke={p.bbBand} dot={false} strokeWidth={1} name="BB upper" isAnimationActive={false} />
        <Line type="monotone" dataKey="bbMiddle" stroke={p.axis} dot={false} strokeDasharray="4 3" strokeWidth={1} name="BB mid (20MA)" isAnimationActive={false} />
        <Line type="monotone" dataKey="bbLower" stroke={p.bbBand} dot={false} strokeWidth={1} name="BB lower" isAnimationActive={false} />
...
function tooltipStyle(p: ReturnType<typeof useChartPalette>) {
  return {
